...
进度: 3890000/3891888 (100.0%) | 可行: 29313 | ETA: 0s
...
│          齿根圆直径 = 12.40 mm
│          输入扭矩 = 2.764 N·m
│  从动轮: 齿数 z4 = 42, 分度圆直径 D4 = 33.60 mm, 齿轮厚度 = 6.40 mm
│          材质: 合金钢 (20CrMnTi), 齿顶修缘 = 0.016 mm
│          齿根圆直径 = 31.60 mm
│          输出扭矩 = 6.126 N·m
│  传动比 i2 = 2.333
...
│  实际齿数配比: (33:120) × (18:42)
│  输出转速: 350 rpm (固定目标值)
│  期望电机转速: 2969.7 rpm (约束: <= 4000 rpm) 【✓ 满足】
...
│ 【各齿轮弯曲应力与应力比详情】
│  第一级啮合 (z1-z2):
│    z1 主动轮: 39.3 MPa, 应力比=0.13
│    z2 从动轮: 38.1 MPa, 应力比=0.47 ← 应力比最大
│
│  第二级啮合 (z3-z4):
│    z3 主动轮: 115.6 MPa, 应力比=0.39
│    z4 从动轮: 110.0 MPa, 应力比=0.37
│
│ 【应力校核总结】
│ 最大应力位置: z3(二级主动)
│ 最大应力比位置: z2(一级从动)
