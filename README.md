...
### 两级齿轮优化结果，z2z3使用同一种材质，z2=peek_cf30，z3=peek_cf30
```
============================================================
齿轮传动优化设计程序
============================================================
...
材料校核模式: 硬约束 (必须满足指定材质)
  第一级: z1=steel, z2=peek_cf30
  第二级: z3=peek_cf30, z4=steel
应力比约束: 硬约束 (最大应力比 < 0.50)

进度: 3890000/3891888 (100.0%) | 可行: 3480 | ETA: 0s
...
│  齿顶修缘系数 = 0.02, 修缘量 = 0.012 mm ✓降噪
│
│  主动轮: 齿数 z1 = 37, 分度圆直径 D1 = 22.20 mm, 齿轮厚度 = 4.80 mm
│          材质: 合金钢 (20CrMnTi), 齿顶修缘 = 0.012 mm
│          齿根圆直径 = 20.70 mm
│          输入扭矩 = 0.700 N·m
│  从动轮: 齿数 z2 = 123, 分度圆直径 D2 = 73.80 mm, 齿轮厚度 = 4.80 mm
│          材质: PEEK-CF30 (碳纤维增强), 齿顶修缘 = 0.012 mm
│          齿根圆直径 = 72.30 mm
│          输出扭矩 = 2.211 N·m
│  传动比 i1 = 3.324
...
├──────────────────────────────────────────────────────┤
│  类型: 直齿轮, 重合度 ε = 1.64
│  模数 m2 = 1.0 mm, 齿距 p2 = 3.142 mm
│  齿顶高 = 1.00 mm, 齿根高 = 1.25 mm, 总齿高 = 2.25 mm
│  齿宽系数 = 10, 轴向厚度(齿宽) = 10.00 mm
│  危险截面齿根宽 sf2 = 0.566 mm (sf/m = 0.566)
│  齿顶修缘系数 = 0.02, 修缘量 = 0.020 mm ✓降噪
│
│  主动轮: 齿数 z3 = 18, 分度圆直径 D3 = 18.00 mm, 齿轮厚度 = 10.00 mm
│          材质: PEEK-CF30 (碳纤维增强), 齿顶修缘 = 0.020 mm
│          齿根圆直径 = 15.50 mm
│          输入扭矩 = 2.211 N·m
│  从动轮: 齿数 z4 = 52, 分度圆直径 D4 = 52.00 mm, 齿轮厚度 = 10.00 mm
│          材质: 合金钢 (20CrMnTi), 齿顶修缘 = 0.020 mm
│          齿根圆直径 = 49.50 mm
│          输出扭矩 = 6.067 N·m
│  传动比 i2 = 2.889
└──────────────────────────────────────────────────────┘
...
│  实际齿数配比: (37:123) × (18:52)
│  输出转速: 350 rpm (固定目标值)
│  期望电机转速: 3361.3 rpm (约束: <= 4000 rpm) 【✓ 满足】
│  输出扭矩: 6.067 Nm (要求 >= 6.0 Nm) 【✓ 满足】
└──────────────────────────────────────────────────────┘
...
├──────────────────────────────────────────────────────┤
│ 轴距参数:
│   第一级中心距 (电机轴-中间轴): 48.00 mm
│   第二级中心距 (中间轴-输出轴): 35.00 mm
│ 齿轮轴向总厚度: 14.80 mm (两级齿轮厚度之和)
│ 总体轴向尺寸: 29.80 mm (齿轮厚度 + 轴承间隙15mm)
│ 最大径向尺寸: 73.80 mm (电机直径参考: 75 mm)
│
│ 纵向尺寸组成:
│   电机半径: 37.50 mm
│   D1/2 (一级主动轮半径): 11.10 mm
│   D2/2 (一级从动轮半径): 36.90 mm
│   D3/2 (二级主动轮半径): 9.00 mm
│   D4 (二级从动轮直径): 52.00 mm
│   总纵向尺寸:               120.50 mm 
│
│ 齿轮组重量: 106.8 g
│ 电机重量: 300 g
│ 系统总重量:               406.8 g (0.407 kg) ← 优化指标
└──────────────────────────────────────────────────────┘
...
│ z1(一级主动)│ 合金钢 (20CrMnTi)       │  600.0  │  0.30  │    2.0   │    300.0
│ z2(一级从动)│ PEEK-CF30 (碳纤维增强)    │  180.0  │  0.55  │    2.2   │     81.8
│ z3(二级主动)│ PEEK-CF30 (碳纤维增强)    │  180.0  │  0.55  │    2.2   │     81.8
│ z4(二级从动)│ 合金钢 (20CrMnTi)       │  600.0  │  0.30  │    2.0   │    300.0
│
│ 注: 标准20°压力角齿根厚系数 sf/m = 0.566
│
│ 【各齿轮弯曲应力与应力比详情】
│  第一级啮合 (z1-z2):
│    z1 主动轮: 30.5 MPa, 应力比=0.10
│    z2 从动轮: 29.7 MPa, 应力比=0.36
│
│  第二级啮合 (z3-z4):
│    z3 主动轮: 37.9 MPa, 应力比=0.46 ← 应力比最大
│    z4 从动轮: 35.8 MPa, 应力比=0.12
│
│ 【应力校核总结】
│ 最大应力位置: z3(二级主动)
│ 最大应力比位置: z3(二级主动)
...
│ 轴距约束验证: ✓ 通过
│ 齿轮间隙验证 (((D1+D2)-(电机直径+D3)) > 1.0mm):
│   计算: ((22.20+73.80)-(75.00+18.00)) = 3.00 mm 【✓ 通过】
│ 低速级相对强度系数: 3.47 (>1.0表示低速级更强)
└──────────────────────────────────────────────────────┘
